...
const ImageOutlinePlate = ({ setClipartEditorView }) => {
  ...
  const handleSelOutline = () => {
    handlePropertyChange('clipArtOutline', SelOutline, TextArray, setTextArray)
        ...
        <div className="color-palette flex flex-col gap-4">
          <div className="flex gap-1 items-center">
            ...
            <div
              ...
              onClick={() => ChangeEditorView("outlinePlate")}
            >
              <div 
...
export default ImageOutlinePlate;
