...
const UploadSize = () => {
  ...
  // const [inputValue, setInputValue] = useState(getNumericValue(ActiveObject?.UploadSize));
  const [inputValue, setInputValue] = useState(ActiveObject?.UploadSize);

  const onChange = (value) => {
    setInputValue(value);
    handlePropertyChange('UploadSize', value, TextArray, setTextArray)
  };
